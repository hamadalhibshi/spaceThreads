...
urlpatterns = [
    ...
    path('listReviews/<int:story_id>/', views.listReviews, name='list_reviews'),
    path('createReview/<int:story_id>/', views.createReview, name='create_review'),
    ...
    path('createComment/<int:story_id>/', views.createComment, name='create_comment_for_story'),
